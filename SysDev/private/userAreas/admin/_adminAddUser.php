...
<form class = 'col-6' action ="<?php echo $_SERVER['PHP_SELF']; ?>" method = "POST">
    ...
    <select class="form-control" id="usertype" name = "usertype">
	  ...
	  <input type="text" class="form-control" name = "firstN" id="fname" required>
	
	  <label class="col-form-label" for="lname">Last Name</label>
	  <input type="text" class="form-control" name = "lastN" id="lname" required>
	
	  <label class="col-form-label" for="phone">Phone (10 digits, no spaces or hyphens)</label>
	  <input type="text" class="form-control" name = "tele" id="phone" required>
	
	  <label class="col-form-label" for="email">Email</label>
	  <input type="text" class="form-control" name = "emailAdd" id="email" required>

	  <label class="col-form-label" for="pword">Password</label>
	  <input type="text" class="form-control" name = "pword" id="pword" required>
	
	  <label class="col-form-label" for="street">Street Address</label>
	  <input type="text" class="form-control" name = "streetAdd" id="street" required>
	
	  <label class="col-form-label" for="city">City</label>
	  <input type="text" class="form-control" name = "cityAdd" id="city" required>
	
	  <label class="col-form-label" for="email">State</label>
	  <input type="text" class="form-control" name = "stateAdd" id="state" required>

	  <label class="col-form-label" for="zip">Zip</label>
	  <input type="text" class="form-control" name = "zipAdd" id="zip" required>
		...
		<div id = "studentLevelChoice" class = addStudentControls>
			  ...
			  <div class="form-group">
			    <div class="custom-control custom-radio">
			      <input type="radio" id="undergraduate" name="grad-under" value = 'undergrad' class="custom-control-input" checked required>
			      <label class="custom-control-label" for="undergraduate">Undergraduate</label>
			    </div>
			    <div class="custom-control custom-radio">
			      <input type="radio" id="graduate" name="grad-under" value = 'grad' class="custom-control-input" required>
		     ...
		     <legend>Enrollment Type</legend>
			  <div  class="form-group">
			    <div class="custom-control custom-radio">
			      <input type="radio" id="fulltime" name="enrollment" class="custom-control-input"  value = "full" checked required>
			      <label class="custom-control-label" for="fulltime">Full time</label>
			    </div>
			    <div class="custom-control custom-radio">
			      <input type="radio" id="parttime" name="enrollment" class="custom-control-input" value = "part" required>
			  ...
			  <div id = "undergradStudyDetails" class="form-group">
			    ...
			    <select class="form-control" id="courseDeptAddUsrMajor" name = "majorDeclaration" required>
				...
				?>
				 ...
				 <select class="form-control" id="courseDeptAddUsrMinor" name = "minorDeclaration" required>
				    <?php //this code populates the dropdown from the DB
			  ...
			  <div id = 'gradProgramDec' class="form-group" >
			    ...
			    <select class="form-control" id="gradProgramDeclaration" name = "gradProgramDeclaration" required>
				    <?php //this code populates the dropdown from the DB
		...
		<div class = "addFacultyControls">
			...
			<div class = 'form-group'>	
			    ...
			    <select class="form-control" id="courseDeptAddUsr" name = "facultyDept_Id" required>
				    <?php //this code populates the dropdown from the DB
