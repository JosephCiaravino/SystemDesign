...
<main class = "container">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link" data-toggle="tab" href="#viewCurrentSched"><i class="far fa-clock"></i>&nbsp;Your Current Schedule</a>
        </li>

         <li class="nav-item">
          <a class="nav-link" data-toggle="tab" href="#registration"><i class="fas fa-edit"></i>&nbsp;Registration</a>
        </li>

         <li class="nav-item">
          <a class="nav-link" data-toggle="tab" href="#profile"><i class="far fa-user"></i>&nbsp;Profile</a>
        </li>

        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#dropdown1" role="button" aria-haspopup="true" aria-expanded="false">Dropdown</a>
    ...
    <div id="myTabContent" class="tab-content">
      ...
      <div class = "tab-pane fade" id = "registration">
        <p>
          Here we will place all relevant functiona sn stuff for registration
        </p>
      </div>
